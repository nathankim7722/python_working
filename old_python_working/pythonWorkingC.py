...
def update():
    dateStr = input("Which day's log would you like to change?(YYYY-MM-DD): ").strip()
    entries = loadEntries()
...
def main():
    command = input("명령어를 입력하세요 (list / update / today / YYYY-MM-DD), 새 로그 작성은 Enter: ").strip()
